...
export type LifecycleBlock = {
  ...
  readonly ignore_changes?: readonly string[] | "all";
  readonly replace_triggered_by?: readonly string[];
  readonly precondition?: readonly ConditionBlock[];
  readonly postcondition?: readonly ConditionBlock[];
};

export type ProvisionerBlock = {
  readonly [type: string]: {
    readonly when?: "create" | "destroy";
    readonly on_failure?: "continue" | "fail";
    readonly connection?: ConnectionBlock;
    readonly [key: string]: unknown;
  };
};
...
export type ConnectionBlock = {
  ...
  readonly target_platform?: "unix" | "windows";
  readonly bastion_host?: string;
  readonly bastion_host_key?: string;
  readonly bastion_port?: number;
  readonly bastion_user?: string;
  readonly bastion_password?: string;
  readonly bastion_private_key?: string;
  readonly bastion_certificate?: string;
  readonly https?: boolean;
  readonly insecure?: boolean;
  readonly use_ntlm?: boolean;
